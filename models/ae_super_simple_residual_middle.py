...
class AESuperSimpleResidualMiddle(nn.Module):

    def __init__(self):
        super(AESuperSimpleResidualMiddle, self).__init__()

        self.enc1 = nn.Conv1d(1, 1, 3, 1, 1)
        self.enc2 = nn.Conv1d(1, 1, 3, 2, 1)
        self.enc3 = nn.Conv1d(1, 1, 3, 2, 1)

        self.middle1 = nn.Conv1d(1, 1, 3, 1, 1)
        self.middle2 = nn.Conv1d(1, 1, 3, 1, 1)
        self.middle3 = nn.Conv1d(1, 1, 3, 1, 1)
        self.middle4 = nn.Conv1d(1, 1, 3, 1, 1)
