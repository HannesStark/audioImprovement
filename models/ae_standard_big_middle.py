...
class AEStandardBigMiddle(nn.Module):

    def __init__(self):
        super(AEStandardBigMiddle, self).__init__()
        ...
        self.middle1 = nn.Conv1d(32, 32, 3, 1, 1)
        self.middle2 = nn.Conv1d(32, 32, 3, 1, 1)
        self.middle3 = nn.Conv1d(32, 32, 3, 1, 1)
        self.middle4 = nn.Conv1d(32, 32, 3, 1, 1)
        self.middle5 = nn.Conv1d(32, 32, 3, 1, 1)
        self.middle6 = nn.Conv1d(32, 32, 3, 1, 1)
        self.middle7 = nn.Conv1d(32, 32, 3, 1, 1)
        self.middle8 = nn.Conv1d(32, 32, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        x = F.selu(self.middle5(x))
        x = F.selu(self.middle6(x))
        x = F.selu(self.middle7(x))
        x = F.selu(self.middle8(x))
